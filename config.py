...
def MyParser():
    ...
    parser.add_argument("--codebook_weight", type=str, default=None, help="e.g. ['5','1','0.5','0.1']") # TODO: change this to fit 8 codebooks
    ...
    parser.add_argument('--n_codebooks', type=int, default=4) #TODO: change this to 8
