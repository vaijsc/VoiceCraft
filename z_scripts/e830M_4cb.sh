...
exp_name=e830M_4cb_fb_max_tok_50k_grad_50_lr_5e-3
dataset_dir="/home/thivt1/data/datasets/gigaspeech_phn_enc_manifest_4cb_fb/xs/" # xs if you only extracted xs in previous step
encodec_codes_folder_name="encodec_24khz_4codebooks"
