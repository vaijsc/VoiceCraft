'''
gen manifest (train.txt and validation.txt) for 8 codebook 24khz dataset
'''
...
def create_train_val():
    ...
    enc_folder = "/home/thivt1/data/datasets/gigaspeech_phn_enc_manifest_8cb/xs/encodec_24khz_8codebooks"
    phn_folder = "/home/thivt1/data/datasets/gigaspeech_phn_enc_manifest_8cb/xs/phonemes"
    ...
    # Define file paths
    train_file_path = '/home/thivt1/data/datasets/gigaspeech_phn_enc_manifest_8cb/xs/manifest/train.txt'
    validation_file_path = '/home/thivt1/data/datasets/gigaspeech_phn_enc_manifest_8cb/xs/manifest/validation.txt'
